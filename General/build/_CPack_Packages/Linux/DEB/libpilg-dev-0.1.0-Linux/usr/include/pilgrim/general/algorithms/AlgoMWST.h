 ...
 *=============================================================================
 */
#ifndef SL_ALGO_MWST_H
#define SL_ALGO_MWST_H
...
/**
 *  Implementation of the Mimimum Weighted Spanning Tree (MWST) algorithm
 */
template <typename rowDataType>
class pmAlgoMWST : public pmAlgorithm<rowDataType>
{
public:
  /**
   *  Constructor.
   */
  pmAlgoMWST(pmCSVDataSet *ds, pmDecomposableScore<rowDataType> *pScore, pmCache *cache = NULL, bool debugVerbose = false);
  ...
  /**
   *  Computes the bayesian network structure by using the MWST algorithm
   */
  ...
  */
  ...
  /**
   *  NO INITBN IN MWST, NEVER USE IT
   */
