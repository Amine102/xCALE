...
public:
  ...
  */
  ...
  /** Assignment operator from a string. 
      Assumes that the corresponding plVariable is of type plLabelType.
...
inline plData& plData::operator=(const plData &data)
{
  ...
  case plData::FLOAT_INT:
    float_value_ = plFloat(data.int_value_);
    break;
  case plData::FLOAT_FLOAT:
    float_value_ = data.float_value_;
    break;
...
//=============================================================================
template <>
inline plData &plData::operator=(const unsigned long long int& int_number)
{
  return set_from_int(int_number);
}
...
//=============================================================================
#ifndef SWIG // we want Swig to go through double, to avoid losing precision
template <>
...
inline plData plData::operator*(const plData &data) const 
{
  ...
  case plData::INT_FLOAT:
    ...
    res.float_value_ = plFloat(int_value_)*data.float_value_; 
    break;
  case plData::FLOAT_INT:
    res.data_type_ = plData::kplFLOAT;
    res.float_value_ = float_value_*plFloat(data.int_value_); 
    break;
  case plData::FLOAT_FLOAT:
    res.data_type_ = plData::kplFLOAT;
...
// //=============================================================================
// inline plData::operator size_t() const
// {
//   size_t res;
//   to_int_number(res);
//   return res;
...
//=============================================================================
inline plData::operator std::string() const 
{
  return as_label();
}
