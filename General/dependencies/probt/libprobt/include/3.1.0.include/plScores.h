...
class PL_DLL_API plNodeScore: public plScore
{
 public:
  ...
  virtual plFloat operator()(const plVariable& node,
...
class PL_DLL_API plNodeScoreAIC: public plNodeScore_t
{
 public:
  ...
  plFloat operator()(const plVariable& node,
...
class PL_DLL_API plEdgeScore  : public  plScore
{
 public:
  ...
  virtual plFloat operator()(const plVariable& A, const plVariable& B) const = 0;
  
  /// Compute the Conditional score of variables A and B knowing
  /// the variable C.
  virtual plFloat operator()(const plVariable& A, const plVariable& B, 
...
class PL_DLL_API plEdgeScoreMI: public plEdgeScore
{
 public:
  ...
  plFloat operator()(const plVariable& A, const plVariable& B) const PL_OVERRIDE;

  /// Compute the Conditional Mutual Information of variables A and B knowing
  /// the variable C.
  plFloat operator()(const plVariable& A, const plVariable& B, 
