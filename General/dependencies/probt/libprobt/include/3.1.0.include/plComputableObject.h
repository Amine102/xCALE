...
class PL_DLL_API plComputableObjectList : public plObject
{
  ...
  */
  ...
  plComputableObjectList ancestral_order_distributions() const;

  /** Get an ancestral ordering of the variables */
  plVariablesConjunction ancestral_order_variables() const;
...
class PL_DLL_API plComputableObject : public plObject
{
...
#ifdef PL_HAVE_CPP11
  /** Move constructor */
  plComputableObject(plComputableObject&& tmp_other);

  /** Move assignment */
  plComputableObject& operator=(plComputableObject&& tmp_other);
#endif
  ...
  */
  ...
  /** Computes the value of the function for the input parameter
      ...
      Calling compute() on distributions resulting from the ask
  ...
  */
  ...
  plProbValue compute(const long double *values)const;
  ...
  */
  ...
  plFloat compute_log(const long double *values)const;
  ...
  */
  ...
  plProbValue compute(const std::vector <long double> &parameter)const;
  ...
  */
  ...
  plFloat compute_log(const std::vector <long double> &parameter)const;
  ...
  */
  ...
  /** Displays the evaluation tree corresponding to the computable object.
      ...
      \sa get_exhaustive_compilation_complexity()
      \sa get_exhaustive_update_complexity
  */
  ...
  /** Get the sum of the number of sums and the number of products required to
      ...
      \sa get_exhaustive_update_complexity() 
      \sa print_evaluation_tree_infos()
  */
  ...
  */
  ...
  inline size_t left_variable_dim() const
  {
    return searched_variables_data_values_.size();
  }

  /** Get the dimension of the right variables */
  inline size_t right_variable_dim() const
  {
    return known_variables_data_values_.size();
  }

  /** Only for Python: Plot the distribution */
  void python_plot()
  {
    THROW_PL_ERROR(89, "plComputableObject.python_plot() is only available for Python");
  }
