...
/*! \mainpage ProBT Documentation
  ...
  - ProBT provides basic <b>data pre-processing</b> functionalities such as:
  ...
  a sample set of points (Forward samping, Metropolis, ...).
  ...
  ProBT objects, for example, into a file or a memory buffer.
  ...
  are encouraged to write to the probt-users mailing list (probt-users@probayes.com):
  http://www.probayes.com/fr/recherche/probt/
...
#include <plLearnDistributions.h>
...
#include <plConcurrentHmmSetLearner.h>
...
#ifdef PL_V23_COMPATIBILITY
#include <plBackwardCompatibilityV23.h>
#endif
