...
public:
  ...
  */ 
  ...
  void add_interval_point(long double point)
  {
    add_interval_point_impl(point);
  }
  void add_interval_point(double point)
  {
    add_interval_point_impl(point);
  }
  void add_interval_point(float point)
  {
    add_interval_point_impl(point);
  }
 ...
 private:
  template<typename T>
    void add_interval_point_impl(T point);
