...
public:
  ...
  /** Creates a learnable log-normal distribution with fixed standard
      ...
      distribution.
  */
  plBayesLearnLogNormalWithKnownShape(plVariable const & variable,
				      plFloat init_mu,
				      plFloat init_sigma,
				      plFloat s,
				      plFloat theta);
...
protected:
  ...
  */
  explicit plBayesLearnLogNormalWithKnownShape(plVariable const & variable);
...
public:
  ...
  */
  ...
  {
    total_weight_ *= s;
    learnable_normal_.rescale_total_weight(s);
  }
