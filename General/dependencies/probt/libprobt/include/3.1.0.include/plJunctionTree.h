...
*/
class PL_DLL_API plJunctionTree : public plObject
{
 private:
  ...
  */
  ...
  /** Outputs the internal structures of the clique graph
      in this junction tree.
  */
  void output_clique_tree_dot(std::ostream & os,
  ...
  /** Outputs the internal structures of the clique graph
      in this junction tree.
  */
  void output_clique_tree_dot(const std::string & file_name,
                              const std::string &dot_graph_label="",
                              const std::string &dot_node_shape="", 
                              const std::string &dot_node_color="",
                              const std::string &dot_node_fill_color="",
  ...
  /** Only for Python: Same as output_clique_tree_dot() above.
      ...
      \sa output_clique_tree_dot()
  */
  void python_draw_clique_tree()
  {
    THROW_PL_ERROR(89, "plJunctionTree.python_draw_clique_tree() is only available for Python");
  }

  /** Outputs the internal structures of the clique graph
      in this junction tree.
  */
  std::string print_clique_tree() const;
