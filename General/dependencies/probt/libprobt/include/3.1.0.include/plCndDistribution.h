...
class PL_DLL_API plCndDistribution : public plComputableObject
{
  ...
  */
  ...
  /** Same as above but the variables are assumed to be those of the passed @em values */
  void partial_instantiate(plCndDistribution& distribution_to_instantiate,
			   const plValues& values)const
  {
    partial_instantiate(distribution_to_instantiate, values.get_variables(), values);
  }
  ...
  */
  ...
  /** Same as above but the variables are assumed to be those of the passed @em values */
  plCndDistribution partial_instantiate(const plValues& values)const
  {
    return partial_instantiate(values.get_variables(), values);
  }
  ...
  */
  ...
  void instantiate(plDistribution& distribution_to_instantiate, const long double *parameter, 
                   bool ensure_normalization_on_compute=true) const;
  plDistribution instantiate(const long double *parameter, bool ensure_normalization_on_compute=true) const;
  ...
  */
  ...
  void instantiate(plDistribution& distribution_to_instantiate,  
                   const std::vector <long double> &parameter, 
                   bool ensure_normalization_on_compute=true) const;
  plDistribution instantiate( const std::vector<long double>& parameter, 
                              bool ensure_normalization_on_compute=true)const;
  ...
  */
  ...
  void instantiate(plDistribution& distribution_to_instantiate, long double parameter, 
                   bool ensure_normalization_on_compute=true) const;
  ...
  */
  ...
  plDistribution instantiate( long double parameter,
                              bool ensure_normalization_on_compute=true) const;
  ...
  */
  ...
  /** Computes the value of the function for the input parameters
      @em  left_params and @em right_params.
  */
  plProbValue compute(const long double *left_params,
                      const long double *right_params)const;
  ...
  */
  ...
  /** Computes the logarithm value of the function for the array input parameters
      @em  left_params and @em right_params.
  */
  plFloat compute_log(const long double *left_params,
                      const long double *right_params)const;
  ...
  */
  ...
  /** Computes the value of the function for the one-dimensional input parameters
      @em left_param and @em right_param.
  */
  plProbValue compute(long double left_param, long double right_param)const;
  ...
  */
  ...
  /** Computes the logarithm value of the function for the one-dimensional input parameters
      @em left_param and @em right_param.
  */
  plFloat compute_log(long double left_param, long double right_param)const;
  ...
  */
  ...
  /** Computes the value of the function for the STL vector input @em  left_params
      and @em right_params.
  */
  plProbValue compute(const std::vector <long double> &left_params,
                      const std::vector <long double> &right_params)const;
  ...
  */
  ...
  /** Computes the logarithm value of the function for the STL vector input @em  left_params
      and @em right_params.
  */
  plFloat compute_log(const std::vector <long double> &left_params,
                      const std::vector <long double> &right_params)const;
  ...
  */
  ...
  /** Validate the conditional distribution used as predictor and return its
      ...
      \sa plBayesianNetwork::validate_prediction()
  */
  plPredictionPerformanceReport validate_prediction(plDataDescriptor &data,
                                                    unsigned int nrows=std::numeric_limits<unsigned int>::max()) const;

  /** Apply the conditional distribution used as predictor and return the predicted value for each data record.

      It assumes no missing values in the data set

      \sa plBayesianNetwork::apply_prediction()
  */
  std::vector<plValues> apply_prediction(plDataDescriptor &data,
                                         unsigned int nrows=std::numeric_limits<unsigned int>::max()) const;
