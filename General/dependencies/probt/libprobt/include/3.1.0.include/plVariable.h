...
class PL_DLL_API plVariable : public plVariablesConjunction
{
  ...
  */
  ...
  /** Return an identifier for this variable. Two copies of the same variable
      are guaranteed to have the same identifier. This value is not guaranteed
      to be stable accross runs or serializations.
   */
  int_fast64_t id() const;
