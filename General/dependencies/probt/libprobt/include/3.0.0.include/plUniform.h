...
public:
  ...
  */
  ...
  /** Create a multi-dimensional uniform on a set of variables 
      It's equivalent to plDistribution( plUniform(vriables[0])*plUniform(vriables[1])*...*plUniform(vriables[vriables.size()-1]) )
  */
  static plDistribution create_uniform(const plVariablesConjunction &vriables);
