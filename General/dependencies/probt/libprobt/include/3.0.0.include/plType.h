...
class PL_DLL_API plType : public plSampleSpaceObject
{
 ...
 public:
  ...
  /** Returns \em true if \em v has a successor and sets \em v
      to the successor otherwise it return \em false.
  */
  bool next_value(float &v) const
  {
    return next_value_impl(v);
  }
  /** Returns \em true if \em v has a successor and sets \em v
      to the successor otherwise it return \em false.
  */
  bool next_value(double &v) const
  {
    return next_value_impl(v);
  }
  ...
  /** Returns \em true if \em v has a successor and sets \em v
      to the successor otherwise it return \em false.
  */
  bool next_value(long double &v) const
  {
    return next_value_impl(v);
  }
  ...
  */
  ...
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const plData &value) const;

  /** For discretized types, get the index representing the given value.
      Throws if the type is not discretized. Return false if the value is invalid,
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const int &value) const
  {
    return get_value_index_impl(result, value);
  }
  ...
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const unsigned int &value) const
  {
    return get_value_index_impl(result, value);
  }
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const long int &value) const
  {
    return get_value_index_impl(result, value);
  }
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const unsigned long int &value) const
  {
    return get_value_index_impl(result, value);
  }
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const float &value) const
  {
    return get_value_index_impl(result, value);
  }
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const double &value) const
  {
    return get_value_index_impl(result, value);
  }
  /** For discretized types, get the index representing the given value.
      ...
      true otherwise. 
  */
  bool get_value_index(unsigned int &result, const long double &value) const
  {
    return get_value_index_impl(result, value);
  }
 ...
 private:
  template <typename T> bool next_value_impl(T &v) const;
  template <typename T> bool get_value_index_impl(unsigned int &result, const T &value) const;
};
