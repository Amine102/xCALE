...
public:
  ...
  */
    ...
    , data_vector_(data_points)
  {
    ...
    //   const std::vector<PointT> *dptr = const_cast<const std::vector<PointT>*>(&data_vector_[0]);
    //   set_data(dptr);
    // }
  }
  ...
  */ 
  size_t run()
  {
    ...
    if(forgy_initialization_) assign();
...
struct plNdCartesian
{
  ...
  /** Add a vector point to an other */
