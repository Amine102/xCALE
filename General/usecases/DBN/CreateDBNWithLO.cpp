#include "CreateDBNWithLO.h"

using namespace PILGRIM;

void CreateDBNWithLO() {

  pmDynamicBayesianNetwork* DBN = createActualDBNWithLO();
  
  DBN->summary(true);
  
  DBN->generate_csv_data("../../benchmarks/data/dbn", 10, 1000, false, 2);
  DBN->save_as_xml("../../benchmarks/networks/DBN_with_LO.xml", "jd0", "jdT");
...
pmDynamicBayesianNetwork* createActualDBNWithLO() {
  ...
  learnObjectList.push_back(new plLearnFrozenDistribution(P_A));
  ...
  learnObjectList.push_back(new plLearnFrozenDistribution(P_B));
  ...
  learnObjectList.push_back(new plLearnFrozenDistribution(P_C));
  ...
  learnObjectList.push_back(new plLearnFrozenDistribution(P_D));
  ...
  BN_0->setLearnObject(learnObjectList);
