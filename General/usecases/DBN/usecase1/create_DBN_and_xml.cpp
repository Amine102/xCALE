...
//Bayesian Network of the initial state
 ...
 //Transition Bayesian Network 
  ...
  DBN->save_as_xml("../../benchmarks/networks/jdDBN.xml","jd0", "jdT");
  cout << "DBN saved as xml" << endl;

  pmDynamicBayesianNetwork* cpDBN = new pmDynamicBayesianNetwork();
  cpDBN = cpDBN->load_from_xml("../../benchmarks/networks/jdDBN.xml");
