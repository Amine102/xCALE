...
testing::Uint32 fn1() {
    ...
    plVariablesConjunction variables = BNAsiaenvironment.bnAsiaLearn.getVariables();
    ...
    BNAsiaenvironment.bnAsiaLearn.setLearnObject(learnObjectList);


    
    BNAsiaenvironment.bnAsiaLearn.learnParameters(BNAsiaenvironment.data);
    BNAsiaenvironment.bnAsiaLearn.summary();
